...
const Form = (props) => {
    ...
    return(
      <form 
        className="needs-validation App" 
        id="signUpForm" 
      ...
      >
        ...
        <div className="form-row">
          ...
          <div className="col-md-4 mb-3">
            ...
            <input 
              ...
              placeholder="NPI" 
              value={props.npi} 
              onChange={props.handleChange('npi')} 
              required
            />
          </div>
        </div>
        ...
        <div className="form-row">
          ...
          <div className="col-md-3 mb-3">
            ...
            <input 
              ...
              onChange={props.handleChange('homeState')} 
              required
            />
          </div>
          <div className="col-md-3 mb-3">
        ...
        <button className="btn btn-primary button" id="okButton" type="submit" >
          Submit
        </button>
      </form>
    )
